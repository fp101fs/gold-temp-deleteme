...
export default function Home() {
  ...
  return (
    <>
      ...
      <main
        ref={revealRef}
        className="relative z-10 mx-auto max-w-6xl px-4 pt-28 pb-20 sm:px-6 lg:px-8"
      >
        {/* ── Hero ── */}
        <section className="flex flex-col items-center text-center">
          <span className="reveal-up glass mb-6 inline-block rounded-full px-4 py-1.5 text-xs font-medium uppercase tracking-widest text-gold-300">
            ✦ Now in Public Beta
          </span>

          <h1 className="reveal-up text-gradient-gold text-4xl font-bold leading-tight sm:text-5xl md:text-6xl lg:text-7xl">
            Build on the
            <br />
            Gold Standard
          </h1>

          <p className="reveal-up mt-6 max-w-2xl text-base text-gold-200/70 sm:text-lg">
          ...
          <div className="reveal-up mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            <a
              href="#cta"
              className="pulse-ring rounded-xl bg-gradient-to-r from-gold-500 to-gold-400 px-8 py-3.5 text-sm font-semibold text-[#0f0b05] shadow-lg shadow-gold-500/30 transition-all duration-300 hover:shadow-gold-400/50 hover:brightness-110"
            >
              Get Started
            </a>
          </div>
        ...
        <section className="mt-24 grid grid-cols-2 gap-4 sm:grid-cols-4">
          {[
            ...
            >
              <GlassCard className="glass-card-hover text-center">
        ...
        <section id="features" className="mt-32">
          <h2 className="reveal-up text-gradient-gold mb-4 text-center text-3xl font-bold sm:text-4xl">
            Everything you need
          </h2>
          <p className="reveal-up mx-auto mb-14 max-w-xl text-center text-gold-200/60">
        ...
        {/* ── Testimonial ── */}
        <section className="reveal-scale mt-32">
          <GlassCard className="glass-glow glass-card-hover mx-auto max-w-3xl p-8 text-center sm:p-12">
